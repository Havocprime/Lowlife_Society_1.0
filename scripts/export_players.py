...
rows = con.execute("""SELECT id, discord_id, username, joined_at, last_seen_at, flags FROM players""").fetchall()
...
with out.open("w", newline="", encoding="utf-8") as f:
    ...
    for r in rows:
        w.writerow([r["id"], r["discord_id"], r["username"], r["joined_at"], r["last_seen_at"], r["flags"]])
print(out)
